...
const Navbar = () => {
  ...
  return (
    <nav className="w-full fixed top-0 left-0 right-0 z-20 flex justify-center px-4 pt-4">
      <div
        className="relative w-full max-w-5xl flex items-center justify-between px-5 py-2.5 rounded-2xl border border-white/10 shadow-[0_4px_40px_rgba(0,0,0,0.5)] overflow-hidden"
