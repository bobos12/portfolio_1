...
const ProjectCard = ({ index, name, description, tags, image, source_code_link }) => {
  return (
    <motion.div
      ...
      className='bg-[#0d0d0d] border border-white/[0.07] p-5 rounded-2xl sm:w-[340px] w-full shadow-[0_8px_32px_rgba(0,0,0,0.6)] hover:shadow-[0_8px_40px_rgba(255,255,255,0.04)] hover:border-white/[0.14] transition-colors duration-300 cursor-default'
    >
